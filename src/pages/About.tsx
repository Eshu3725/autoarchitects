      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Meet the dedicated faculty member guiding our engineering journey
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <Card className="p-8 md:p-12 border-0 shadow-elegant">
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                  ...
                  <div className="md:col-span-2 text-center md:text-left">
                    <h3 className="font-display font-bold text-3xl text-steel-dark mb-2">
                      Dr. Michael Chen
                    </h3>
                    <p className="text-energy font-semibold text-lg mb-4">
                      Professor of Mechanical Engineering
                    </p>
                    <div className="space-y-4 text-muted-foreground">
                      <p>
                        Dr. Chen brings over 15 years of experience in automotive engineering 
                        and vehicle dynamics to the VeloTech ATV Club. His expertise in 
                        advanced manufacturing and sustainable engineering practices has been 
                        instrumental in our club's success.
                      </p>
                      <p>
                        Under his guidance, the club has achieved national recognition and 
                        pioneered innovative approaches to ATV design, including our 
                        award-winning electric ATV prototype.
                      </p>
                      <div className="flex flex-wrap gap-2 justify-center md:justify-start mt-6">
                        <span className="bg-energy/10 text-energy px-3 py-1 rounded-full text-sm font-medium">
